...
export const Contact = ({md,setmd}) => {

   const [data,setData]  = useState({email:'',phone:'',subject:'',message:''}) 
  ...
  return (
    ...
    <Header current={3} md={md} setmd={setmd}/>
   
<section className="bg-ternary py-1 pb-md-5">
  <div className="container">
    <div className="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
      <div className="col-12 col-lg-6">
        <div className="row justify-content-xl-center">
          <div className="col-12 col-xl-11">
            <h2 className={`fs-1 mb-3 text-${md.color}`}>Get in touch</h2>
            <p className="lead fs-4 text-secondary mb-5">if you want to contact me then here is my contact detail or you can direct send me a message via this form</p>
            ...
            <div className="row mb-5">
              <div className="col-12 col-sm-6">
                <div className="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    <h4 className={`mb-3 text-${md.color}`}>Phone</h4>
                    <p className="mb-0">
              ...
              <div className="col-12 col-sm-6">
                <div className="d-flex mb-0">
                  ...
                  <div>
                    <h4 className={`mb-3 text-${md.color}`}>Gmail</h4>
                    <p className="mb-0">
      ...
      <div className="col-12 col-lg-6">
        <div className="bg-ternary border  shadow-sm overflow-hidden">

          <form action="#!">
            <div className={`row bg-ternary  text-${md.color} gy-4 gy-xl-5 p-4 p-xl-51`}>
              ...
              <div className="col-12 col-md-6">
                ...
                <div className="input-group">
                  ...
                  <input type="email" onChange={(e)=>setData({email:e.target.value})} value={data.email} className="form-control" id="email" name="email"  required/>
                </div>
              </div>
              <div className="col-12 col-md-6">
                ...
                <div className="input-group">
                  ...
                  <input type="tel" value={data.phone} onChange={(e)=>setData({phone:e.target.value})}  className="form-control" id="phone" name="phone" />
                </div>
              </div>
              <div className="col-12">
                <label htmlFor="subject" className="form-label">Subject <span className="text-danger">*</span></label>
                <input  type="text" value={data.subject} onChange={(e)=>setData({subject:e.target.value})}  className="form-control" id="subject" name="subject" required/>
              </div>
              <div className="col-12">
                <label htmlFor="message" className="form-label">Message <span className="text-danger">*</span></label>
                <textarea value={data.message} onChange={(e)=>setData({message:e.target.value})}  className="form-control"  id="message" name="message" rows="3" required></textarea>
              </div>
              <div className="col-12">
